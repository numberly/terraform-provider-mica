...
// Ensure objectStoreAccountExportDataSource satisfies the datasource interfaces.
...
// NewObjectStoreAccountExportDataSource is the factory function registered in the provider.
