...
func (c *FlashBladeClient) PostSmbSharePolicy(ctx context.Context, name string, body SmbSharePolicyPost) (*SmbSharePolicy, error) {
	return postOne[SmbSharePolicyPost, SmbSharePolicy](c, ctx, "/smb-share-policies?names="+url.QueryEscape(name), body, "PostSmbSharePolicy")
}
...
func (c *FlashBladeClient) PatchSmbSharePolicy(ctx context.Context, name string, body SmbSharePolicyPatch) (*SmbSharePolicy, error) {
	return patchOne[SmbSharePolicyPatch, SmbSharePolicy](c, ctx, "/smb-share-policies?names="+url.QueryEscape(name), body, "PatchSmbSharePolicy")
}
...
func (c *FlashBladeClient) PostSmbSharePolicyRule(ctx context.Context, policyName string, body SmbSharePolicyRulePost) (*SmbSharePolicyRule, error) {
	return postOne[SmbSharePolicyRulePost, SmbSharePolicyRule](c, ctx, "/smb-share-policies/rules?policy_names="+url.QueryEscape(policyName), body, "PostSmbSharePolicyRule")
}
...
func (c *FlashBladeClient) PatchSmbSharePolicyRule(ctx context.Context, policyName, ruleName string, body SmbSharePolicyRulePatch) (*SmbSharePolicyRule, error) {
	return patchOne[SmbSharePolicyRulePatch, SmbSharePolicyRule](c, ctx, "/smb-share-policies/rules?names="+url.QueryEscape(ruleName)+"&policy_names="+url.QueryEscape(policyName), body, "PatchSmbSharePolicyRule")
}
