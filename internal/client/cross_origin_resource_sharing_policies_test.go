...
const corsPolicyPath = "/api/2.22/buckets/cross-origin-resource-sharing-policies"
const corsRulesPath = "/api/2.22/buckets/cross-origin-resource-sharing-policies/rules"
