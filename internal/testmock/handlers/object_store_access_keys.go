...
// RegisterObjectStoreAccessKeyHandlers registers CRUD handlers for /api/<APIVersion>/object-store-access-keys
...
// handleGet handles GET /api/<APIVersion>/object-store-access-keys with optional ?names= param.
...
// handlePost handles POST /api/<APIVersion>/object-store-access-keys.
...
// handleDelete handles DELETE /api/<APIVersion>/object-store-access-keys?names={name}.
