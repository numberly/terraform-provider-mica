...
// RegisterNetworkInterfaceHandlers registers CRUD handlers for /api/<APIVersion>/network-interfaces
...
// handleGet handles GET /api/<APIVersion>/network-interfaces with optional ?names= param.
...
// handlePost handles POST /api/<APIVersion>/network-interfaces?names={name}&subnet_names={subnet}.
...
// handlePatch handles PATCH /api/<APIVersion>/network-interfaces?names={name}.
...
// handleDelete handles DELETE /api/<APIVersion>/network-interfaces?names={name}.
