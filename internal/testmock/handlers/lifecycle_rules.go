...
// RegisterLifecycleRuleHandlers registers CRUD handlers for /api/<APIVersion>/lifecycle-rules
...
// handleGet handles GET /api/<APIVersion>/lifecycle-rules with optional query parameters:
...
// handlePost handles POST /api/<APIVersion>/lifecycle-rules.
...
// handlePatch handles PATCH /api/<APIVersion>/lifecycle-rules.
...
// handleDelete handles DELETE /api/<APIVersion>/lifecycle-rules.
// Identification by ?names= (composite key "bucketName/ruleID").
