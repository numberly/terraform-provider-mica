...
//   - /api/<APIVersion>/tls-policies (policy CRUD)
//   - /api/<APIVersion>/tls-policies/members (member GET list)
//   - /api/<APIVersion>/network-interfaces/tls-policies (member POST/DELETE)
//
...
// handlePolicyGet handles GET /api/<APIVersion>/tls-policies.
...
// handlePolicyPost handles POST /api/<APIVersion>/tls-policies.
...
// handlePolicyPatch handles PATCH /api/<APIVersion>/tls-policies.
...
// handlePolicyDelete handles DELETE /api/<APIVersion>/tls-policies.
...
// handleMember dispatches GET /api/<APIVersion>/tls-policies/members requests.
...
// handleMemberGet handles GET /api/<APIVersion>/tls-policies/members.
...
// handleNITlsPolicies dispatches POST/DELETE /api/<APIVersion>/network-interfaces/tls-policies requests.
...
// handleMemberPost handles POST /api/<APIVersion>/network-interfaces/tls-policies.
...
// handleMemberDelete handles DELETE /api/<APIVersion>/network-interfaces/tls-policies.
