...
// handleFileSystems handles GET /api/<APIVersion>/policies/file-systems?policy_names={name}.
...
// handlePolicyGet handles GET /api/<APIVersion>/policies with optional ?names= param.
...
// handlePolicyPost handles POST /api/<APIVersion>/policies?names={name}.
...
// handlePolicyPatch handles PATCH /api/<APIVersion>/policies?names={name}.
...
// handlePolicyDelete handles DELETE /api/<APIVersion>/policies?names={name}.
