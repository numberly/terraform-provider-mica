...
// /api/<APIVersion>/array-connections/connection-key against the provided ServeMux.
...
// handleGet handles GET /api/<APIVersion>/array-connections/connection-key.
...
// handlePost handles POST /api/<APIVersion>/array-connections/connection-key.
