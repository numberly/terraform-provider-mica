...
// RegisterCertificateHandlers registers CRUD handlers for /api/<APIVersion>/certificates
...
// handleGet handles GET /api/<APIVersion>/certificates with optional ?names= param.
...
// handlePost handles POST /api/<APIVersion>/certificates?names={name}.
...
// handlePatch handles PATCH /api/<APIVersion>/certificates?names={name}.
...
// handleDelete handles DELETE /api/<APIVersion>/certificates?names={name}.
