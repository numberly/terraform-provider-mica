...
// handlePolicyGet handles GET /api/<APIVersion>/nfs-export-policies with optional ?names= param.
...
// handlePolicyPost handles POST /api/<APIVersion>/nfs-export-policies?names={name}.
...
// handlePolicyPatch handles PATCH /api/<APIVersion>/nfs-export-policies?names={name}.
...
// handlePolicyDelete handles DELETE /api/<APIVersion>/nfs-export-policies?names={name}.
...
// handleRulesGet handles GET /api/<APIVersion>/nfs-export-policies/rules.
...
// handleRulesPost handles POST /api/<APIVersion>/nfs-export-policies/rules?policy_names={name}.
...
// handleRulesPatch handles PATCH /api/<APIVersion>/nfs-export-policies/rules?names={name}&policy_names={policy}.
...
// handleRulesDelete handles DELETE /api/<APIVersion>/nfs-export-policies/rules?names={name}&policy_names={policy}.
