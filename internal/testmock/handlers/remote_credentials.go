...
// RegisterRemoteCredentialsHandlers registers CRUD handlers for /api/<APIVersion>/object-store-remote-credentials
...
// handleGet handles GET /api/<APIVersion>/object-store-remote-credentials with optional ?names= param.
...
// handlePost handles POST /api/<APIVersion>/object-store-remote-credentials.
...
// handlePatch handles PATCH /api/<APIVersion>/object-store-remote-credentials?names={name}.
...
// handleDelete handles DELETE /api/<APIVersion>/object-store-remote-credentials?names={name}.
