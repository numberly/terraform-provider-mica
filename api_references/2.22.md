...
- **POST** `/api/2.22/array-connections` | Body: `ca_certificate_group`(object), `connection_key`(string), `context`(object), `encrypted`(boolean), `id`(ro string), `management_address`(string), `os`(ro string), `remote`(object), `replication_addresses`(array), `status`(ro string), `throttle`(object), `type`(ro string), `version`(ro string)
...
- **POST** `/api/2.22/token`
- **GET** `/api/2.22/api_version`
- **POST** `/api/2.22/login`
- **POST** `/api/2.22/logout`
- **GET** `/api/2.22/login-banner`
...
- **PATCH** `/api/2.22/file-system-exports` | Body: `context`(object), `enabled`(ro boolean), `export_name`(string), `id`(ro string), `member`(object), `name`(ro string), `policy`(object), `policy_type`(ro string), `server`(object), `share_policy`(object), `status`(ro string)
...
- **PATCH** `/api/2.22/file-system-snapshots` | Params: `latest_replica`(boolean) | Body: `context`(object), `created`(ro integer), `destroyed`(boolean), `id`(ro string), `name`(string), `owner`(object), `owner_destroyed`(ro boolean), `policies`(ro array), `policy`(object), `source`(object), `suffix`(ro string), `time_remaining`(ro integer)
...
- **POST** `/api/2.22/keytabs/upload` | Params: `name_prefixes`(string)
...
- **POST** `/api/2.22/network-interfaces` | Body: `address`(string), `attached_servers`(array), `enabled`(ro boolean), `gateway`(ro string), `id`(ro string), `mtu`(ro integer), `name`(ro string), `netmask`(ro string), `realms`(ro array), `services`(array), `subnet`(ro object), `type`(string), `vlan`(ro integer)
...
- **PATCH** `/api/2.22/object-store-access-keys` | Body: `access_key_id`(ro string), `context`(object), `created`(ro integer), `enabled`(boolean), `name`(ro string), `secret_access_key`(ro string), `user`(object)
...
- **PATCH** `/api/2.22/object-store-remote-credentials` | Body: `access_key_id`(string), `context`(object), `id`(ro string), `name`(string), `realms`(ro array), `remote`(object), `secret_access_key`(string)
...
- **PATCH** `/api/2.22/object-store-roles` | Body: `account`(object), `context`(object), `created`(ro integer), `id`(ro string), `max_session_duration`(integer), `name`(ro string), `prn`(ro string), `trusted_entities`(ro array)
...
- **POST** `/api/2.22/object-store-virtual-hosts` | Body: `attached_servers`(array), `context`(object), `hostname`(string), `id`(ro string), `name`(ro string), `realms`(ro array)
...
- **PATCH** `/api/2.22/data-eviction-policies` | Body: `context`(object), `enabled`(boolean), `id`(ro string), `is_local`(ro boolean), `keep_size`(integer), `location`(object), `name`(string), `policy_type`(ro string), `realms`(ro array)
...
- **PATCH** `/api/2.22/management-authentication-policies` | Body: `context`(object), `enabled`(boolean), `id`(ro string), `is_local`(ro boolean), `location`(object), `name`(string), `policy_type`(ro string), `realms`(ro array), `ssh`(object)
...
- **PATCH** `/api/2.22/smb-client-policies/rules` | Params: `before_rule_id`(string), `before_rule_name`(string), `versions`(array) | Body: `client`(string), `context`(object), `encryption`(string), `id`(ro string), `index`(integer), `name`(ro string), `permission`(string), `policy`(object), `policy_version`(ro string)
...
- **POST** `/api/2.22/worm-data-policies` | Body: `context`(object), `default_retention`(integer), `enabled`(boolean), `id`(ro string), `is_local`(ro boolean), `location`(object), `max_retention`(integer), `min_retention`(integer), `mode`(string), `name`(ro string), `policy_type`(ro string), `realms`(ro array), `retention_lock`(string)
- **PATCH** `/api/2.22/worm-data-policies` | Body: `context`(object), `default_retention`(integer), `enabled`(boolean), `id`(ro string), `is_local`(ro boolean), `location`(object), `max_retention`(integer), `min_retention`(integer), `mode`(string), `name`(ro string), `policy_type`(ro string), `realms`(ro array), `retention_lock`(string)
...
- **PATCH** `/api/2.22/realms/defaults` | Params: `realm_ids`(array), `realm_names`(array) | Body: `context`(object), `object_store`(array), `realm`(object)
...
The  | `smb`(object):  | `snapshot_directory_enabled`(boolean): If set to `true`, a hidden .snapshot directory wil | `source`(object):  | `space`(object):  | `storage_class`(object):  | `time_remaining`(ro integer): Time in milliseconds before the file system is era | `writable`(boolean): Whether the file system is writable or not. If `fa
...
The  | `smb`(object):  | `snapshot_directory_enabled`(boolean): If set to `true`, a hidden .snapshot directory wil | `source`(object):  | `storage_class`(object):  | `time_remaining`(ro integer): Time in milliseconds before the file system is era | `writable`(boolean): Whether the file system is writable or not. If `fa
...
The  | `smb`(object):  | `snapshot_directory_enabled`(boolean): If set to `true`, a hidden .snapshot directory wil | `source`(object):  | `writable`(boolean): Whether the file system is writable or not. If `fa
...
**Node**: `capacity`(ro integer): The available capacity of the node in bytes.
 | `data_addresses`(ro array): List of data IP addresses of the node.
...
**QosPolicy**: `enabled`(boolean): If `true`, the policy is enabled. If not specified | `id`(ro string): A globally unique, system-generated ID.
