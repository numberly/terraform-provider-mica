...
| `remote_ids` | array | A comma-separated list of remote array IDs. If, after filtering, there... |
| `remote_names` | array | A comma-separated list of remote array names. If, after filtering, the... |
