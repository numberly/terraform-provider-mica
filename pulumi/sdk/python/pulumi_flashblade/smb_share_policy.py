...
class SmbSharePolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a SmbSharePolicy resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: SmbSharePolicyArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a SmbSharePolicy resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param SmbSharePolicyArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(SmbSharePolicyArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = SmbSharePolicyArgs.__new__(SmbSharePolicyArgs)
        ...
        super(SmbSharePolicy, __self__).__init__(
            'flashblade:index/smbSharePolicy:SmbSharePolicy',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
        ...
        __props__ = _SmbSharePolicyState.__new__(_SmbSharePolicyState)
