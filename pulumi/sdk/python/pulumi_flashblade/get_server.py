...
def get_server(name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('flashblade:index/getServer:getServer', __args__, opts=opts, typ=GetServerResult).value
...
def get_server_output(name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('flashblade:index/getServer:getServer', __args__, opts=opts, typ=GetServerResult)
