...
def get_subnet(name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('flashblade:index/getSubnet:getSubnet', __args__, opts=opts, typ=GetSubnetResult).value
...
def get_subnet_output(name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('flashblade:index/getSubnet:getSubnet', __args__, opts=opts, typ=GetSubnetResult)
