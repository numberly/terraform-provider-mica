...
def get_certificate(name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('mica:index/getCertificate:getCertificate', __args__, opts=opts, typ=GetCertificateResult).value
...
def get_certificate_output(name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('mica:index/getCertificate:getCertificate', __args__, opts=opts, typ=GetCertificateResult)
