...
def get_bucket(name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('mica:index/getBucket:getBucket', __args__, opts=opts, typ=GetBucketResult).value
...
def get_bucket_output(name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('mica:index/getBucket:getBucket', __args__, opts=opts, typ=GetBucketResult)
