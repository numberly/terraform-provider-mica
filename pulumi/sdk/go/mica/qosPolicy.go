...
func NewQosPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("mica:index/qosPolicy:QosPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetQosPolicy(ctx *pulumi.Context,
	...
	var resource QosPolicy
	err := ctx.ReadResource("mica:index/qosPolicy:QosPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
