...
- [x] Phase 57: CI Pipeline (completed 2026-04-22)
- [x] Phase 58: Release Pipeline + Docs (completed 2026-04-22)
...
- [x] 58-03-PLAN.md — README.md + CHANGELOG.md + Makefile docs target
...
- [x] 55-02-PLAN.md — SECRETS-03 auto-mapping test + SOFTDELETE-03 + UPGRADE-01/02/03 tests + ComputeID unit tests + schema regeneration
**UI hint**: no
...
_Last updated: 2026-04-22 — Phase 57 completed (pulumi-ci.yml + .goreleaser.pulumi.yml)_
