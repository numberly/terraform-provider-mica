...
- [ ] 50-02-PLAN.md — Mock handlers: /directory-services/roles GET/POST/PATCH/DELETE with name-derivation (strip pure:policy/) + readonly-on-PATCH guard, and /management-access-policies/directory-services/roles GET/POST/DELETE as idempotent pair set
