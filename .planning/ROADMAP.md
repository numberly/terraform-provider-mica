...
- [ ] **Phase 49: Directory Service Management** — Implement `flashblade_directory_service_management` resource + data source, client CRUD, mock handler, tests (≥787), HCL examples, and generated docs.
...
|-------|----------------|--------|-----------|
| 49. Directory Service Management | 1/5 | In Progress|  |
