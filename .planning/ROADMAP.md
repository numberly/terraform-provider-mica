...
- [ ] 50-05-PLAN.md — Provider registration + HCL examples (resource.tf/import.sh/data-source.tf x2 groups) + make docs + ROADMAP.md/CONVENTIONS.md updates + make test (>=812) + make lint (clean)
**UI hint**: no
...
| Phase | Plans Complete | Status | Completed |
|-------|----------------|--------|-----------|
| 50. Directory Service Roles & Role Mappings | 4/5 | In Progress|  |
